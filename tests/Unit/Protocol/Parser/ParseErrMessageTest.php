...
final class ParseErrMessageTest extends AsyncTestCase
{
    public function testMessage(): void
    {
        ...
        $this->runAsyncTest(function () {
            ...
            $callback = function (NatsProtocolMessageInterface $message) use(&$isParsed): void {
                self::assertInstanceOf(ErrMessage::class, $message);
                self::assertSame('Unknown Protocol Operation', $message->getPayload());
            ...
            $source = function (): \Generator {
                yield "-ERR Unknown Protocol Operation\r\n";
            };
